...
with os.scandir(dir) as pcaps:
    for pcap in pcaps:
        ...
        os.system('snort -c /usr/local/etc/snort/snort.lua -l /home/salas/Escritorio/lista_ataques/alertas/' + folder + ' -r /home/salas/Escritorio/lista_ataques/pcaps/' + pcap.name)
        os.system('chmod 666 /home/salas/Escritorio/lista_ataques/alertas/'+folder+'/*')
        if os.stat('/home/salas/Escritorio/lista_ataques/alertas/'+folder+'/alert_fast.txt').st_size == 0:
